...
-- Script SQL complet à exécuter dans Supabase (inclut le champ profil)
...
CREATE TABLE IF NOT EXISTS acquereurs (
  ...
  profil TEXT NOT NULL DEFAULT 'personne_seule' CHECK (profil IN ('personne_seule', 'couple', 'famille', 'famille_nombreuse', 'investisseur', 'residence_secondaire')),
